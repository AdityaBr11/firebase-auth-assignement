...
const Login = () => {
  ...
  const google = () => {
    signInWithPopup(auth, googleAuthProvider)
      .then((result) => {
        const userCredential = result.userCredential;
    ...
    <>
      <div className="relative flex flex-col justify-center mt-20 overflow-hidden ">
        <ToastContainer
          ...
          theme="light"
        ></ToastContainer>
        <div className="w-[90%] p-6 m-auto bg-black/50 rounded-md shadow-xl md:w-[35%] px-16 ">
          <h1 className="text-3xl font-semibold text-center text-gray-300 uppercase">
            Login
          </h1>
          <form className="mt-6" onSubmit={handleSubmit(loginForm)}>
            <div className="mb-2">
              <p>Email</p>
              <input
                type="email"
          ...
          <div className="relative flex items-center justify-center w-full py-5 mt-5">
            <div className="absolute px-5 bg-transparent ">Or</div>
          </div>
          <div className="flex mt-4 gap-x-2">
            <button onClick={google}
              type="button"
              className="flex items-center justify-center w-full p-2 border border-gray-300 rounded-md focus:ring-2 focus:ring-offset-1 focus:ring-violet-600"
            >
              <svg
            ...
            <button className="flex items-center justify-center w-full p-2 border border-gray-300 rounded-md focus:ring-2 focus:ring-offset-1 focus:ring-violet-600">
              <svg
                xmlns="http://www.w3.org/2000/svg"
                viewBox="0 0 32 32"
                className="w-5 h-5 fill-current"
